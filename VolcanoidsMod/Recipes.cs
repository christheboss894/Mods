...
namespace VolcanoidsMod
{
    public class Recipes : MonoBehaviour
    {
        private void Awake()
        {
            ...
            CreateRecipeSimple("TitaniumIngot", 15, "CrystalIngot", 10, "2E3EE998AD8F470CAF35471421CA3AAE", "TungstenIngot", 1, "AlloyT3Recipe", "TungstenIngotRecipe", 2f);

            CreateRecipeSimple("AlloyT4Ingot", 30, "DiamondIngot", 20, "61C5C4430D7F42D2B599A582C44E930E", "UnobtainiumIngot", 1, "AlloyT3Recipe", "UnobtainiumIngotRecipe", 5f);

            CreateRecipeSimple("TungstenIngot", 2, "TitaniumIngot", 1, "A7E62288C0D646739C2F53968C210957", "AlloyT4Ingot", 1, "UnobtainiumIngotRecipe", "AlloyT4Recipe", 2f);

            CreateRecipeSimple("TungstenIngot", 1, "46ACCE55EE28490BA14F73C08A83050C", "TungstenPlates", 2, "ResearchT3_AnalyzerRecipe", "TungstenPlatesRecipe", 1.5f);
            ...
            CreateRecipeSimple("TungstenIngot", 1, "CFA38F3064494CF884D40EE8DA2772E8", "TungstenBolts", 2, "TungstenTubesRecipe", "TungstenBoltsRecipe", 1.5f);

            CreateRecipeSimple("UnobtainiumIngot", 1, "71FAB79094F4495291EDABB2D67146B0", "UnobtainiumPlates", 2, "TungstenPlatesRecipe", "UnobtainiumPlatesRecipe", 1.5f);
            ...
            CreateRecipeSimple("UnobtainiumIngot", 1, "4C1A520F5ECB45B0A0C0CD3E2A2CC109", "UnobtainiumBolts", 2, "UnobtainiumTubesRecipe", "UnobtainiumBoltsRecipe", 1.5f);
            ...
            CreateRecipeSimple("UnobtainiumPlates", 10, "UnobtainiumBolts", 10, "UnobtainiumIngot", 15, "B37606501B2B40FABF697CEF68C26DA4", "HullT6_Unobtainium", 1, "HullUpgrade5Recipe", "HullUpgrade6Recipe", 5f);
