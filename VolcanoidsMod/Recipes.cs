...
namespace VolcanoidsMod
{
    public class Recipes : MonoBehaviour
    {
        private void Awake()
        {
            ...
            CreateRecipeSimple("AlloyT3Ingot", 40, "IntelResearchT3", 5, "IntelRefineryT3", 5, "IntelProductionT3", 5, "Parts_TracksT4_Advanced", 5, "EABEBE7067F44B228BDEBAC23548AE47", "TracksT5_Supreme", 1, "TracksUpgrade4Recipe", "TracksT5Recipe", 2f);
            ...
            CreateRecipeSimple("TungstenIngot", 12, "IntelRefineryT3", 4, "IntelProductionT3", 4, "D7415C76EB4A438C86432501D59998E0", "ShipCoreUpgrade5", 1, "ShipCoreUpgrade4Recipe", "ShipCoreUpgrade5Recipe", 2f);
            CreateRecipeSimple("TitaniumIngot", 15, "AlloyT3Ingot", 10, "2E3EE998AD8F470CAF35471421CA3AAE", "TungstenIngot", 1, "AlloyT3Recipe", "TungstenIngotRecipe", 2f);
            CreateRecipeSimple("TungstenPlates", 5, "TungstenBolts", 4, "A3046813A43345AEB6A8AA5353E8A77B", "HullT5_Tungsten", 1, "HullUpgrade4Recipe", "HullUpgrade5Recipe", 2f);
            CreateRecipeSimple("UnobtainiumPlates", 20, "UnobtainiumBolts", 10, "UnobtainiumIngot", 15, "B37606501B2B40FABF697CEF68C26DA4", "HullT6_Unobtainium", 1, "HullUpgrade5Recipe", "HullUpgrade6Recipe", 5f);
            CreateRecipeSimple("TungstenIngot", 5, "2CBFF4BD72C54C6AA7D85B4AA22711D7", "DrillT5_Tungsten", 1, "DrillUpgrade4Recipe", "DrillUpgrade5Recipe", 2f);  
            CreateRecipeSimple("UnobtainiumIngot", 15, "UnobtainiumPlates", 10, "UnobtainiumTubes", 10, "UnobtainiumPlates", 10, "C922C8F07B294F98BAF5AAAD706F2E4E4", "DrillT6_Unobtainium", 1, "DrillUpgrade5Recipe", "DrillUpgrade6Recipe", 5f);
            CreateRecipeSimple("AlloyT4Ingot", 30, "DiamondIngot", 20, "61C5C4430D7F42D2B599A582C44E930E", "UnobtainiumIngot", 1, "TungstenIngotRecipe", "UnobtainiumIngotRecipe", 5f);
            CreateRecipeSimple("TungstenIngot", 1, "TitaniumIngot", 1, "A7E62288C0D646739C2F53968C210957", "AlloyT4Ingot", 1, "AlloyT3Recipe", "AlloyT4Recipe", 2f);
            CreateRecipeSimple("TungstenIngot", 1, "CFA38F3064494CF884D40EE8DA2772E8", "TungstenBolts", 2, "TitaniumPlatesRecipe", "TungstenBoltsRecipe", 1.5f);
            CreateRecipeSimple("TungstenIngot", 1, "46ACCE55EE28490BA14F73C08A83050C", "TungstenPlates", 2, "TungstenBoltsRecipe", "TungstenPlatesRecipe", 1.5f); 
            CreateRecipeSimple("TungstenIngot", 1, "A5D9565795624D7FAD861F8FC0B0403D", "TungstenTubes", 1, "TungstenPlatesRecipe", "TungstenTubesRecipe", 1.5f); 
            CreateRecipeSimple("UnobtainiumIngot", 1, "4C1A520F5ECB45B0A0C0CD3E2A2CC109", "UnobtainiumBolts", 2, "UnobtainiumPlatesRecipe", "UnobtainiumBoltsRecipe", 1.5f);
            CreateRecipeSimple("UnobtainiumIngot", 1, "71FAB79094F4495291EDABB2D67146B0", "UnobtainiumPlates", 2, "TungstenPlayesRecipe", "UnobtainiumPlatesRecipe", 1.5f); 
            CreateRecipeSimple("UnobtainiumIngot", 1, "66BFCE9D2EEF494BA6AC7CF56DB66E1C", "UnobtainiumTubes", 1, "UnobtainiumPlatesRecipe", "UnobtainiumTubesRecipe", 1.5f); 
